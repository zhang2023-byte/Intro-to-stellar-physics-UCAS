...
## 本次逐课核实：v2-ch05、v2-ch06、v2-ch07（2026-09-15）

以下只确认新课采用的具体概念、关系式和模型条件；前文候选表的其他范围不据此升级。主书为 Böhm-Vitense, Volume 2: Stellar Atmospheres（1989）；Ref 为 Carroll 与 Ostlie《当代天体物理学导论》原书第二版中文本（2023）。表中页码均分别标出印刷页和各章拆分 PDF 页序。

| 主书具体范围 | 核实内容 | Ref 对应及页码 | 状态与边界 |
|---|---|---|---|
| §§5.1–5.2，印刷39–42／拆分1–4；式5.1–5.12 | 向内垂直光深符号、μ、半无限形式解、线性与多项式源函数积分 | §§9.4.4、9.4.6，印刷212–215、217–219／第9章拆分22–25、27–29 | 已核实所列关系；Ref直接给线性例，阶乘系数用主书及解析积分核对。 |
| §§5.3–5.4，印刷43–46／拆分5–8；式5.14–5.27 | 实际通量角积分、表面边界、2/3关系、有效温度与灰/LTE假设 | §9.1.3，印刷193–194／拆分3–4；§9.4.5，215–217／25–27 | 已核实。课件实际F等于主书πF；2/3关系保留线性源函数近似，温度关系增加灰和LTE条件。 |
| §§5.5–5.6，印刷47–50／拆分9–12；式5.28–5.36 | 各向同性零通量、圆盘平均、距离稀释、J与u | §§9.1.1–9.1.3，印刷191–194／拆分1–4 | 已核实定义；圆盘积分以主书为依据，不声称Ref复现其完整推导。 |
| §6.1，印刷51–53／拆分1–3；式6.1–6.5 | 临边多项式反演、绝对源函数与温度、深层不确定性 | §9.4.6，印刷217–219／第9章拆分27–29 | 已核实所用关系；活动是原创系数，未使用主书章末5010 Å观测表。Ref只直接覆盖线性情形。 |
| §6.2，印刷53–55／拆分3–5；式6.6–6.8 | 同温度同层的条件、累计光深及路径平均不透明度比 | §9.2.6，印刷205–206／第9章拆分15–16，只作平均不透明度背景 | 已核实主书关系；PDF确认式6.8第二个比值的分母为κλ1，MinerU误识为κλ2。Ref未覆盖相同的多波长经验反演方法。 |
| §6.3，印刷57–59／拆分7–9；式6.9–6.16 | 总通量守恒、灰积分J=S与非灰加权积分、对流边界 | §9.4.4，印刷214–215／第9章拆分24–25 | 已核实所列条件；未采用太阳对流占比的历史数值，未要求每个波段单独平衡。 |
| §6.4，印刷63–67／拆分13–17；式6.19–6.39 | 角矩、Eddington闭合、近似表面边界、灰LTE温度律 | §9.4.5，印刷215–217／第9章拆分25–27，尤其式9.53 | 已核实主要温度律直接对应；课件明确2/3为近似边界，未把它当精确灰大气解。Ref不替代主书全部矩推导。 |
| §§7.1–7.3，印刷68–77／拆分1–10；式7.1–7.17 | 氢能级和连续阈值、统计权重、Boltzmann及含配分函数的Saha | §§8.1.3–8.1.5，印刷174–181／第8章拆分7–14 | 已核实所用公式；阈值活动采用13.6 eV近似；两能级人口活动为截断模型，不生成绝对截面表。 |
| §§7.4–7.6，印刷77–81／拆分10–14 | H−、氦与金属的连续吸收和电子供应 | §§9.2.4–9.2.5，印刷202–205／第9章拆分12–15 | 已核实概念；主书H−约0.7 eV、约1.7 μm与Ref的0.754 eV、1640 nm分清取整口径。Ref不足以替代He/金属逐元素系数。 |
| §§7.7–7.8，印刷81–85／拆分14–18 | Rayleigh远离共振的波长依赖、Thomson散射与能量交换边界 | §9.2.4，印刷203–204／第9章拆分13–14 | 已核实散射类型和截面；主书0.66×10⁻²⁴ cm²与Ref6.65×10⁻²⁹ m²一致至取整。各向同性相干散射源函数为限定模型的补充推导。 |
| §7.9，印刷85–86／拆分18–19 | A/B星不同温度、电子压力下的组分比较 | §9.2.4只提供过程分类，未找到整套系数比较的直接对应 | 已核实主书定性比较条件；课件不复用表格或给出未经计算的固定主导比例。 |

局部结论来自本地 MinerU 与拆分 PDF；教材截图和逐次核查记录仅保存在忽略的本地工作记录中。未联网扩展科学进展。
